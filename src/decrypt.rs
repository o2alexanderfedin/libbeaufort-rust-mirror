...
pub(crate) extern "C" fn beaufort_decrypt(src: *const i8, key: *const i8,
    ...
    if 0 as *mut () == dec as *mut () { return 0 as *mut () as *mut i8; }
    {
        '__b1: loop {
            ...
            '__c1: loop {
                ...
                unsafe {
                    *dec.add({
                        ...
                        unsafe {
                            *unsafe { (*mat.offset(0 as isize)).offset(x as isize) }
                        }
                };
                break '__c1;
            }
